...
cargo -Z unstable-options -C hal clean --target x86_64-unknown-linux-musl && \
...
cargo -Z unstable-options -C strap clean --target x86_64-unknown-linux-musl && \
...
cargo -Z unstable-options -C strap clean --target aarch64-unknown-uefi && \
cargo -Z unstable-options -C kernel clean --target x86_64-unknown-linux-musl && \
