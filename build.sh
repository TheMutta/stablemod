...
cargo -Z unstable-options -C hal check --target x86_64-unknown-linux-gnu && \
cargo -Z unstable-options -C hal check --target x86_64-unknown-uefi && \
cargo -Z unstable-options -C hal check --target aarch64-unknown-uefi && \
cargo -Z unstable-options -C hal check --target x86_64-unknown-none && \
cargo -Z unstable-options -C hal check --target aarch64-unknown-none && \
cargo -Z unstable-options -C strap build --target x86_64-unknown-linux-gnu && \
